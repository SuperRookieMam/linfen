...
public class MBasicBuilder {
    ...
    public  static Predicate getPredicate(CriteriaBuilder builder, Root<?> root,String key,Object value) {
        ...
        return index> -1  ? getPredicate(builder,root,key1, MConditionEnum.valueOf(type),value,JoinType.LEFT):null;
    }
    ...
    public  static Predicate getPredicate(CriteriaBuilder builder, Root<?> root,String key,String type , Object value, JoinType joinType) {
    ...
    private static Predicate addLike(CriteriaBuilder builder, Root<?> root,String key, Object value, JoinType joinType){
        return builder.like(MPathUtil.getPath(root,key,joinType),"%/"+value+"%",'/');
    }
    private static Predicate addNotLike(CriteriaBuilder builder, Root<?> root,String key, Object value, JoinType joinType){
        return builder.notLike(MPathUtil.getPath(root,key,joinType),"%/"+value+"%",'/');
    }
    private static Predicate addLt(CriteriaBuilder builder, Root<?> root,String key, Object value, JoinType joinType){
        Path path = MPathUtil.getPath(root,key,joinType);
    ...
    private static Predicate addNotEq(CriteriaBuilder builder, Root<?> root,String key, Object value, JoinType joinType){
        Path path = MPathUtil.getPath(root,key,joinType);
        return builder.notEqual(path,getComparable(path,value));
    }
    private static Predicate addIn(CriteriaBuilder builder, Root<?> root,String key,JoinType joinType,Object...value){
        Path path = MPathUtil.getPath(root,key,joinType);
    ...
    private static Predicate addNotIn(CriteriaBuilder builder, Root<?> root,String key,JoinType joinType,Object...value){
        Path path = MPathUtil.getPath(root,key,joinType);
    ...
    private static Predicate addIsNull(CriteriaBuilder builder, Root<?> root,String key,JoinType joinType){
        return builder.isNull(MPathUtil.getPath(root,key,joinType));
    }
    private static Predicate addIsNotNull(CriteriaBuilder builder, Root<?> root,String key,JoinType joinType){
        return builder.isNotNull(MPathUtil.getPath(root,key,joinType));
    }
    private static Predicate addIsMember(CriteriaBuilder builder, Root<?> root,String key,JoinType joinType,Object value){
        return builder.isMember(value , MPathUtil.getPath(root,key,joinType));
    }
    private static Predicate addIsNotMember(CriteriaBuilder builder, Root<?> root,String key,JoinType joinType,Object value){
        return builder.isNotMember(value , MPathUtil.getPath(root,key,joinType));
    }
   /**
    * 根据path 回对应的时间类型
    * */
