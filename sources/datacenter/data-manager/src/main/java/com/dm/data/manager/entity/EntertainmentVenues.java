...
@Getter
@Setter
@Entity(name = "entertainment_venues_")
public class EntertainmentVenues extends AbstractCurrency<Long> {
     ...
     * 中文简称
     */
    @Column(name = "chinese_short_name_", length = 50)
     ...
     * 管理公司名称
     */
    @Column(name = "management_of_the_company_name_", length = 50)
