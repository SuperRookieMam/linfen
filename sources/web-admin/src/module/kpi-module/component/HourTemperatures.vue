<template>
  <div>
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <hour-temperature v-model="selectedRow" />
...
<script>
  ...
  @Component({
    components: { HourTemperature }
  })
  export default class HourTemperatures extends Mixins(BaseList) {
    get baseModule () { return 'kpi/hourTemperature' }
  }
</script>
