<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="name" label="来源国家" sortable="custom" />
    ...
    <el-dialog v-if="visible"
      ...
      <year-tourist-in v-model="selectedRow" />
...
<script>
  ...
  import YearTouristIn from './YearTouristIn'

  @Component({
    components: { YearTouristIn }
  })
  export default class YearTouristIns extends Mixins(BaseList) {
    get baseModule () { return 'kpi/yearTouristIn' }
  }
</script>
