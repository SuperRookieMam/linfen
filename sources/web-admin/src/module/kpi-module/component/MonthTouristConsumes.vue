<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="value" label="消费" sortable="custom" />
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <month-tourist-consume v-model="selectedRow" />
...
<script>
  ...
  import MonthTouristConsume from './MonthTouristConsume'

  @Component({
    components: { MonthTouristConsume }
  })
  export default class MonthTouristConsumes extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthTouristConsume' }
  }
</script>
