<template>
  <div>
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <month-team-consume v-model="selectedRow" />
...
<script>
  ...
  import MonthTeamConsume from './MonthTeamConsume'

  @Component({
    components: { MonthTeamConsume }
  })
  export default class MonthTeamConsumes extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthTeamConsume' }
  }
</script>
