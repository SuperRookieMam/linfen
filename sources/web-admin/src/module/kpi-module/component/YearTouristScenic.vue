      ...
      <el-col :span="12">
        <el-form-item prop="name" label="类型">
          <el-select v-model="value.name">
            <el-option value="1个">1个</el-option>
            <el-option value="2个">2个</el-option>
            <el-option value="3个及以上">3个及以上</el-option>
          </el-select>
        </el-form-item>
      </el-col>
      <el-col :span="12">
...
<script>
  ...
  @Component
  export default class yearTouristScenic extends Mixins(BaseForm) {
  }
</script>
