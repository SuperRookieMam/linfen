<template>
  <div>
    ...
    <el-dialog v-if="visible"
      ...
      <month-tourist-team-single v-model="selectedRow" />
...
<script>
  ...
  import MonthTouristTeamSingle from './MonthTouristTeamSingle'

  @Component({
    components: { MonthTouristTeamSingle }
  })
  export default class MonthTouristTeamSingles extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthTouristTeamSingle' }
  }
</script>
