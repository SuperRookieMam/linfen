<template>
  <div>
    ...
    <el-dialog v-if="visible"
      ...
      <year-tourist-scenic v-model="selectedRow" />
...
<script>
  ...
  import yearTouristScenic from './yearTouristScenic'

  @Component({
    components: { yearTouristScenic }
  })
  export default class yearTouristScenics extends Mixins(BaseList) {
    get baseModule () { return 'kpi/yearTouristScenic' }
  }
</script>
