<template>
  <div>
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <year-guided-gender v-model="selectedRow" />
...
<script>
  ...
  import YearGuidedGender from './YearGuidedGender'

  @Component({
    components: { YearGuidedGender }
  })
  export default class YearGuidedGenders extends Mixins(BaseList) {
    get baseModule () { return 'kpi/yearGuidedGender' }
  }
</script>
