<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
                         ...
                         :ajax="ajax">
          <el-table-column prop="name" label="来源" sortable="custom" />
    ...
    <el-dialog v-if="visible"
      ...
      <year-media v-model="selectedRow" />
...
<script>
  ...
  @Component({
    components: { YearMedia }
  })
  export default class YearMedias extends Mixins(BaseList) {
    get baseModule () { return 'kpi/yearMedia' }
  }
</script>
