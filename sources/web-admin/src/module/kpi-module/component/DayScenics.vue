<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="value" label="景区人数" sortable="custom" />
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <day-scenic v-model="selectedRow" />
...
<script>
  ...
  import DayScenic from './DayScenic'

  @Component({
    components: { DayScenic }
  })
  export default class DayScenics extends Mixins(BaseList) {
    get baseModule () { return 'kpi/dayScenic' }
  }
</script>
