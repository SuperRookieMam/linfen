<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="value" label="舒适度" sortable="custom" />
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <day-scenic-comfortable v-model="selectedRow" />
...
<script>
  ...
  import DayScenicComfortable from './DayScenicComfortable'

  @Component({
    components: { DayScenicComfortable }
  })
  export default class DayScenicComfortables extends Mixins(BaseList) {
    get baseModule () { return 'kpi/dayScenicComfortable' }
  }
</script>
