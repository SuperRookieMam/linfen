<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="value" label="气压值" sortable="custom" />
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <hour-pressure v-model="selectedRow" />
...
<script>
  ...
  import HourPressure from './HourPressure'

  @Component({
    components: { HourPressure }
  })
  export default class HourPressures extends Mixins(BaseList) {
    get baseModule () { return 'kpi/hourPressure' }
  }
</script>
