<template>
  <div>
    ...
    <el-dialog v-if="visible"
      ...
      <month-tourist v-model="selectedRow" />
...
<script>
  ...
  import MonthTourist from './MonthTourist'

  @Component({
    components: { MonthTourist }
  })
  export default class MonthTourists extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthTourist' }
  }
</script>
