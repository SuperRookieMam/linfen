<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
                         ...
                         :ajax="ajax">
          <el-table-column prop="name" label="类别" sortable="custom" />
    ...
    <el-dialog v-if="visible"
      ...
      <now-resource v-model="selectedRow" />
...
<script>
  ...
  import NowResource from './NowResource'

  @Component({
    components: { NowResource }
  })
  export default class NowResources extends Mixins(BaseList) {
    get baseModule () { return 'kpi/nowResource' }
  }
</script>
