<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="name" label="省份" sortable="custom" />
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <year-public-opinion-region v-model="selectedRow" />
...
<script>
  ...
  import YearPublicOpinionRegion from './YearPublicOpinionRegion'

  @Component({
    components: { YearPublicOpinionRegion }
  })
  export default class YearPublicOpinionRegions extends Mixins(BaseList) {
    get baseModule () { return 'kpi/yearPublicOpinionRegion' }
  }
</script>
