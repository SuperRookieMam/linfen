<template>
  <div>
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <month-hotel-type v-model="selectedRow" />
...
<script>
  ...
  import MonthHotelType from './MonthHotelType'

  @Component({
    components: { MonthHotelType }
  })
  export default class MonthHotelTypes extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthHotelType' }
  }
</script>
