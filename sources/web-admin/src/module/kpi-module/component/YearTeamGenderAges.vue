<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="age" label="年龄段类型" sortable="custom" />
    ...
    <el-dialog v-if="visible"
      ...
      <year-team-gender-age v-model="selectedRow" />
...
<script>
  ...
  import YearTeamGenderAge from './YearTeamGenderAge'

  @Component({
    components: { YearTeamGenderAge }
  })
  export default class YearTeamGenderAges extends Mixins(BaseList) {
    get baseModule () { return 'kpi/yearTeamGenderAge' }
  }
</script>
