<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="name" label="消费" sortable="custom" />
    ...
    <el-dialog v-if="visible"
      ...
      <year-tourist-consume v-model="selectedRow" />
...
<script>
  ...
  import YearTouristConsume from './YearTouristConsume'

  @Component({
    components: { YearTouristConsume }
  })
  export default class YearTouristConsumes extends Mixins(BaseList) {
    get baseModule () { return 'kpi/yearTouristConsume' }
  }
</script>
