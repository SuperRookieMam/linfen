<template>
  <div>
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <month-team-stay v-model="selectedRow" />
...
<script>
  ...
  import MonthTeamStay from './MonthTeamStay'

  @Component({
    components: { MonthTeamStay }
  })
  export default class MonthTeamStays extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthTeamStay' }
  }
</script>
