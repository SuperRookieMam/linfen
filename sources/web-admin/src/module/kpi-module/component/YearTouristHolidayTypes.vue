<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="name" label="节假日" sortable="custom" />
    ...
    <el-dialog v-if="visible"
      ...
      <year-tourist-holiday-type v-model="selectedRow" />
...
<script>
  ...
  import YearTouristHolidayType from './YearTouristHolidayType'

  @Component({
    components: { YearTouristHolidayType }
  })
  export default class YearTouristHolidayTypes extends Mixins(BaseList) {
    get baseModule () { return 'kpi/yearTouristHolidayType' }
  }
</script>
