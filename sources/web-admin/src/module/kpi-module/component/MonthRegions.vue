<template>
  <div>
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <month-region v-model="selectedRow" />
...
<script>
  ...
  import MonthRegion from './MonthRegion'

  @Component({
    components: { MonthRegion }
  })
  export default class MonthRegions extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthRegion' }
  }
</script>
