<template>
  <div>
    ...
    <el-dialog v-if="visible"
      ...
      <month-hotel-local-in v-model="selectedRow" />
...
<script>
  ...
  import MonthHotelLocalIn from './MonthHotelLocalIn'

  @Component({
    components: { MonthHotelLocalIn }
  })
  export default class MonthHotelLocalIns extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthTourisHotelLocalIn' }
  }
</script>
