<template>
  <div>
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <month-tourist-scenic v-model="selectedRow" />
...
<script>
  ...
  import MonthTouristScenic from './MonthTouristScenic'

  @Component({
    components: { MonthTouristScenic }
  })
  export default class MonthTouristScenics extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthTouristScenic' }
  }
</script>
