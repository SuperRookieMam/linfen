<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="name" label="关键词" sortable="custom" />
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <month-sentiment-keyword v-model="selectedRow" />
...
<script>
  ...
  import MonthSentimentKeyword from './MonthSentimentKeyword'

  @Component({
    components: { MonthSentimentKeyword }
  })
  export default class MonthSentimentKeywords extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthSentimentKeyword' }
  }
</script>
