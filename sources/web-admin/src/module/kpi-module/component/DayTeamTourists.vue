<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="value" label="团队游客数" sortable="custom" />
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <day-team-tourist v-model="selectedRow" />
...
<script>
  ...
  import DayTeamTourist from './DayTeamTourist'

  @Component({
    components: { DayTeamTourist }
  })
  export default class DayTeamTourists extends Mixins(BaseList) {
    get baseModule () { return 'kpi/dayTeamTourist' }
  }
</script>
