<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="name" label="客源地" sortable="custom" />
          <el-table-column prop="value" label="人数(万人)" sortable="custom" />
    ...
    <el-dialog v-if="visible"
      ...
      <year-team-region v-model="selectedRow" />
...
<script>
  ...
  import YearTeamRegion from './YearTeamRegion'

  @Component({
    components: { YearTeamRegion }
  })
  export default class YearTeamRegions extends Mixins(BaseList) {
    get baseModule () { return 'kpi/yearTeamRegion' }
  }
</script>
