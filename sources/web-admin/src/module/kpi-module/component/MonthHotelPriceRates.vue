...
<script>
  ...
  import MonthHotelPriceRate from './MonthHotelPriceRate'

  @Component({
    components: { MonthHotelPriceRate }
  })
  export default class MonthHotelPriceRates extends Mixins(BaseList) {
    get baseModule () { return 'kpi/MonthHotelPriceRate' }
  }
</script>
