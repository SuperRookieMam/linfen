<template>
  <div>
    ...
    <el-dialog v-if="visible"
      ...
      <year-scenic v-model="selectedRow" />
...
<script>
  ...
  import YearScenic from './YearScenic'

  @Component({
    components: { YearScenic }
  })
  export default class YearScenics extends Mixins(BaseList) {
    get baseModule () { return 'kpi/yearScenic' }
  }
</script>
