...
<script>
  ...
  import YearNegKeyword from './YearNegKeyword'

  @Component({
    components: { YearNegKeyword }
  })
  export default class YearNegKeywords extends Mixins(BaseList) {
    get baseModule () { return 'kpi/YearNegKeyword' }
  }
</script>
