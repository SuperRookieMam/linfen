    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="value" label="入住人数" sortable="custom" />
...
<script>
  ...
  import DayHotel from './DayHotel'

  @Component({
    components: { DayHotel }
  })
  export default class DayHotels extends Mixins(BaseList) {
    get baseModule () { return 'kpi/dayHotel' }
  }
</script>
