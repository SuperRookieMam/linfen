<template>
  <div>
    ...
    <el-dialog v-if="visible"
      ...
      <year-region v-model="selectedRow" />
...
<script>
  ...
  import YearRegion from './YearRegion'

  @Component({
    components: { YearRegion }
  })
  export default class YearRegions extends Mixins(BaseList) {
    get baseModule () { return 'kpi/yearRegion' }
  }
</script>
