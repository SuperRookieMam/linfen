<template>
  <div>
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <month-tourist-local-out v-model="selectedRow" />
...
<script>
  ...
  import MonthTouristLocalOut from './MonthTouristLocalOut'

  @Component({
    components: { MonthTouristLocalOut }
  })
  export default class MonthTouristLocalOuts extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthTouristLocalOut' }
  }
</script>
