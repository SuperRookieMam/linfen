<template>
  <div>
    ...
    <el-dialog v-if="visible"
      ...
      <hour-scenic-comfort v-model="selectedRow" />
...
<script>
  ...
  import HourScenicComfort from './HourScenicComfort'

  @Component({
    components: { HourScenicComfort }
  })
  export default class HourScenicComforts extends Mixins(BaseList) {
    get baseModule () { return 'kpi/hourScenicComfort' }
  }
</script>
