<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="name" label="出行目的" sortable="custom" />
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <month-tourist-purpose v-model="selectedRow" />
...
<script>
  ...
  import MonthTouristPurpose from './MonthTouristPurpose'

  @Component({
    components: { MonthTouristPurpose }
  })
  export default class MonthTouristPurposes extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthTouristPurpose' }
  }
</script>
