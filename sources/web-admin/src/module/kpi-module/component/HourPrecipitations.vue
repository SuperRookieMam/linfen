<template>
  <div>
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <hour-precipitation v-model="selectedRow" />
...
<script>
  ...
  // 无效
  @Component({
    components: { HourPrecipitation }
  })
  export default class HourPrecipitations extends Mixins(BaseList) {
    get baseModule () { return 'kpi/hourPrecipitation' }
  }
</script>
