<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="name" label="来源地" sortable="custom" />
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <month-team-region v-model="selectedRow" />
...
<script>
  ...
  import MonthTeamRegion from './MonthTeamRegion'

  @Component({
    components: { MonthTeamRegion }
  })
  export default class MonthTeamRegions extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthTeamRegion' }
  }
</script>
