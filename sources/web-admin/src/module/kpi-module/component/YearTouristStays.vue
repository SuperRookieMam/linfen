<template>
  <div>
    ...
    <el-dialog v-if="visible"
      ...
      <year-tourist-stay v-model="selectedRow" />
...
<script>
  ...
  import YearTouristStay from './YearTouristStay'

  @Component({
    components: { YearTouristStay }
  })
  export default class YearTouristStays extends Mixins(BaseList) {
    get baseModule () { return 'kpi/yearTouristStay' }
  }
</script>
