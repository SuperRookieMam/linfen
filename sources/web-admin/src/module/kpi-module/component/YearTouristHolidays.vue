<template>
  <div>
    ...
    <el-dialog v-if="visible"
      ...
      <year-tourist-holiday v-model="selectedRow" />
...
<script>
  ...
  import YearTouristHoliday from './YearTouristHoliday'

  @Component({
    components: { YearTouristHoliday }
  })
  export default class YearTouristHolidays extends Mixins(BaseList) {
    get baseModule () { return 'kpi/yearTouristHoliday' }
  }
</script>
