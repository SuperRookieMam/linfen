<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="cityName" label="车辆来源" sortable="custom" />
    ...
    <el-dialog v-if="visible"
      ...
      <year-scenic-city-car v-model="selectedRow" />
...
<script>
  ...
  import YearScenicCityCar from './YearScenicCityCar'

  @Component({
    components: { YearScenicCityCar }
  })
  export default class YearScenicCityCars extends Mixins(BaseList) {
    get baseModule () { return 'kpi/yearScenicCityCar' }
  }
</script>
