<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="name" label="年龄段" sortable="custom" />
    ...
    <el-dialog v-if="visible"
      ...
      <year-tourist-age v-model="selectedRow" />
...
<script>
  ...
  import YearTouristAge from './YearTouristAge'

  @Component({
    components: { YearTouristAge }
  })
  export default class YearTouristAges extends Mixins(BaseList) {
    get baseModule () { return 'kpi/yearTouristAge' }
  }
</script>
