    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="value" label="收入" sortable="custom" />
...
<script>
  ...
  import MonthGrossIncome from './MonthGrossIncome'

  @Component({
    components: { MonthGrossIncome }
  })
  export default class MonthGrossIncomes extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthGrossIncome' }
  }
</script>
