<template>
  <div>
    ...
    <el-dialog v-if="visible"
      ...
      <year-team-stay v-model="selectedRow" />
...
<script>
  ...
  import YearTeamStay from './YearTeamStay'

  @Component({
    components: { YearTeamStay }
  })
  export default class YearTeamStays extends Mixins(BaseList) {
    get baseModule () { return 'kpi/yearTeamStay' }
  }
</script>
