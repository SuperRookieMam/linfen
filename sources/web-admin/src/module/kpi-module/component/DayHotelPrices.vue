<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="value" label="当前价格" sortable="custom" />
    ...
    <el-dialog v-if="visible"
      ...
      <day-hotel-price v-model="selectedRow" />
...
<script>
  ...
  import DayHotelPrice from './DayHotelPrice'

  @Component({
    components: { DayHotelPrice }
  })
  export default class DayHotelPrices extends Mixins(BaseList) {
    get baseModule () { return 'kpi/dayHotelPrice' }
  }
</script>
