<template>
  <div>
    ...
    <el-dialog v-if="visible"
      ...
      <month-team-tourist v-model="selectedRow" />
...
<script>
  ...
  import MonthTeamTourist from './MonthTeamTourist'

  @Component({
    components: { MonthTeamTourist }
  })
  export default class MonthTeamTourists extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthTeamTourist' }
  }
</script>
