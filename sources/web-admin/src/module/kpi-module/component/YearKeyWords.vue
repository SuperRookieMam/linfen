...
<script>
  ...
  import YearKeyword from './YearKeyword'

  @Component({
    components: { YearKeyword }
  })
  export default class YearKeywords extends Mixins(BaseList) {
    get baseModule () { return 'kpi/YearKeyword' }
  }
</script>
