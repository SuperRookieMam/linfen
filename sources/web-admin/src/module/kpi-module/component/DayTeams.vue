    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="value" label="团队数" sortable="custom" />
...
<script>
  ...
  import DayTeam from './DayTeam'

  @Component({
    components: { DayTeam }
  })
  export default class DayTeams extends Mixins(BaseList) {
    get baseModule () { return 'kpi/dayTeam' }
  }
</script>
