<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="name" label="职业" sortable="custom" />
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <month-tourist-occupation v-model="selectedRow" />
...
<script>
  ...
  import MonthTouristOccupation from './MonthTouristOccupation'

  @Component({
    components: { MonthTouristOccupation }
  })
  export default class MonthTouristOccupations extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthTouristOccupation' }
  }
</script>
