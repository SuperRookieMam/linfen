<template>
  <div>
    ...
    <el-dialog v-if="visible"
      ...
      <year-industry v-model="selectedRow" />
...
<script>
  ...
  import YearIndustry from './YearIndustry'

  @Component({
    components: { YearIndustry }
  })
  export default class YearIndustrys extends Mixins(BaseList) {
    get baseModule () { return 'kpi/yearIndustrys' }
  }
</script>
