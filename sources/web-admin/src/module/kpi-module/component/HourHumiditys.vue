<template>
  <div>
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <hour-humidity v-model="selectedRow" />
...
<script>
  ...
  // 无效
  @Component({
    components: { HourHumidity }
  })
  export default class HourHumiditys extends Mixins(BaseList) {
    get baseModule () { return 'kpi/hourHumidity' }
  }
</script>
