<template>
  <div>
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <month-team-in v-model="selectedRow" />
...
<script>
  ...
  import MonthTeamIn from './MonthTeamIn'

  @Component({
    components: { MonthTeamIn }
  })
  export default class MonthTeamIns extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthTeamIn' }
  }
</script>
