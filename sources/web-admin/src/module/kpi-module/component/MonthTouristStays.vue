<template>
  <div>
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <month-tourist-stay v-model="selectedRow" />
...
<script>
  ...
  import MonthTouristStay from './MonthTouristStay'

  @Component({
    components: { MonthTouristStay }
  })
  export default class MonthTouristStays extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthTouristStay' }
  }
</script>
