<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="name" label="出行方式" sortable="custom" />
    ...
    <el-dialog v-if="visible"
      ...
      <year-tourist-traffic v-model="selectedRow" />
...
<script>
  ...
  import YearTouristTraffic from './YearTouristTraffic'

  @Component({
    components: { YearTouristTraffic }
  })
  export default class YearTouristTraffics extends Mixins(BaseList) {
    get baseModule () { return 'kpi/yearTouristTraffic' }
  }
</script>
