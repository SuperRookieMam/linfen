<template>
  <div>
    ...
    <el-dialog v-if="visible"
      ...
      <year-tourist-gender v-model="selectedRow" />
...
<script>
  ...
  import YearTouristGender from './YearTouristGender'

  @Component({
    components: { YearTouristGender }
  })
  export default class YearTouristGenders extends Mixins(BaseList) {
    get baseModule () { return 'kpi/yearTouristGender' }
  }
</script>
