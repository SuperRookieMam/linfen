<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="value" label="游客数" sortable="custom" />
    ...
    <el-dialog v-if="visible"
      ...
      <day-tourist v-model="selectedRow" />
...
<script>
  ...
  import DayTourist from './DayTourist'

  @Component({
    components: { DayTourist }
  })
  export default class DayTourists extends Mixins(BaseList) {
    get baseModule () { return 'kpi/dayTourist' }
  }
</script>
