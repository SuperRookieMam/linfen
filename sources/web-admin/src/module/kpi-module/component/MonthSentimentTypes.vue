<template>
  <div>
    ...
    <el-dialog v-if="visible"
      ...
      <month-sentiment-type v-model="selectedRow" />
...
<script>
  ...
  import MonthSentimentType from './YearRegion'

  @Component({
    components: { MonthSentimentType }
  })
  export default class MonthSentimentTypes extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthSentimentType' }
  }
</script>
