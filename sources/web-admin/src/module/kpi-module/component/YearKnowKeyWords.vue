    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="value" label="关键字" sortable="custom" />
...
<script>
  ...
  import YearKnowKeyWord from './YearKnowKeyWord'

  @Component({
    components: { YearKnowKeyWord }
  })
  export default class YearKnowKeyWords extends Mixins(BaseList) {
    get baseModule () { return 'kpi/YearKnowKeyWord' }
  }
</script>
