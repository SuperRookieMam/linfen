<template>
  <div>
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <month-in-region v-model="selectedRow" />
...
<script>
  ...
  import MonthInRegion from './MonthInRegion'

  @Component({
    components: { MonthInRegion }
  })
  export default class MonthInRegions extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthInRegion' }
  }
</script>
