<template>
  <div>
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <month-scenic v-model="selectedRow" />
...
<script>
  ...
  import MonthScenic from './MonthScenic'

  @Component({
    components: { MonthScenic }
  })
  export default class MonthScenics extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthScenic' }
  }
</script>
