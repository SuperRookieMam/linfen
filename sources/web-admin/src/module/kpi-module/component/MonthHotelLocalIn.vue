      ...
      <el-col :span="12">
        <el-form-item prop="name" label="类型">
          <el-select v-model="value.name">
            <el-option value="国内游客">国内游客</el-option>
            <el-option value="入境游客">入境游客</el-option>
          </el-select>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item prop="value" label="人数">
...
<script>
  ...
  @Component
  export default class MonthHotelLocalIn extends Mixins(BaseForm) {
  }
</script>
