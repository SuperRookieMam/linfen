<template>
  <div>
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <month-team-type v-model="selectedRow" />
...
<script>
  ...
  import MonthTeamType from './MonthTeamType'

  @Component({
    components: { MonthTeamType }
  })
  export default class MonthTeamTypes extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthTeamType' }
  }
</script>
