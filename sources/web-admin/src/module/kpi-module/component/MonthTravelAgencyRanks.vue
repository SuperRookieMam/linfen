<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <ele-data-tables ref="list"
          ...
          <el-table-column prop="name" label="旅行社" sortable="custom" />
    ...
    <el-dialog v-if="visible" :visible.sync="visible" title="指标编辑">
      <month-travel-agency-rank v-model="selectedRow" />
...
<script>
  ...
  import MonthTravelAgencyRank from './MonthTravelAgencyRank'

  @Component({
    components: { MonthTravelAgencyRank }
  })
  export default class MonthTravelAgencyRanks extends Mixins(BaseList) {
    get baseModule () { return 'kpi/monthTravelAgencyRank' }
  }
</script>
