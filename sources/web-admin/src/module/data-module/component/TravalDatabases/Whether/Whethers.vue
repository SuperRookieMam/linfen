<template>
  <div>
    ...
    <el-table :data="list"
      ...
      <el-table-column label="天气" prop="whether" />
      <el-table-column label="风力" prop="windPower" />
      <el-table-column label="空气指数" prop="airQuality" />
...
<script>
  ...
  @Component
  export default class Whethers extends Mixins(BaseTable) {
    formRoute = 'whether'
