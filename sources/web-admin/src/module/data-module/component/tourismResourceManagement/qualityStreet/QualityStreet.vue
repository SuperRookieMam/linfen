        ...
        <el-tabs>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="街道长度" prop="lengthOfTheStreet">
                  <el-input
                    v-model="data.lengthOfTheStreet"
                    :disabled="readonly"
                    maxlength="20" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="街道特色" prop="characteristicsOfTheStreet">
                  <el-input
                    v-model="data.characteristicsOfTheStreet"
                    :disabled="readonly"
                    maxlength="200" />
                </el-form-item>
              </el-col>
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="特色景点" prop="featureAttractions">
                  <el-input
                    v-model="data.featureAttractions"
                    :disabled="readonly"
                    maxlength="200" />
                </el-form-item>
              </el-col>
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="建议游玩时长" prop="theAdviceToPlayTime">
                  <el-input
                    v-model="data.theAdviceToPlayTime"
                    :disabled="readonly"
                    maxlength="50" />
                </el-form-item>
              </el-col>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="适合游玩季节" prop="suitableForPlayingSeason">
                  <el-input
                    v-model="data.suitableForPlayingSeason"
                    :disabled="readonly"
                    maxlength="200" />
                </el-form-item>
              </el-col>
          ...
          <el-tab-pane label="旅游厕所" v-if="id!=='new'">
            <reference-form :pdata="data"
                            refname="QualityStreet"
                            fieldname="tourismToilet"
                            route-ame="qualityStreetsToilet"
          ...
          <el-tab-pane label="停车场" v-if="id!=='new'">
            <reference-form :pdata="data"
                            ...
                            route-name="qualityStreetsParkingLot"
...
<script>
  ...
  export default class QualityStreet extends Mixins(BaseForm) {
    @Prop({default: () => 'new'})
    id
