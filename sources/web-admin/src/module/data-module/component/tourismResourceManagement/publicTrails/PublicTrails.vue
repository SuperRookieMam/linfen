        ...
        <el-tabs>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="所属公园" prop="subordinateToThePark">
                  <el-input
                    v-model="data.subordinateToThePark"
                    :disabled="readonly"
                    maxlength="50" />
                </el-form-item>
              </el-col>
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="步道特点" prop="trailsCharacteristics">
                  <el-input
                    v-model="data.trailsCharacteristics"
                    :disabled="readonly"
                    maxlength="200" />
                </el-form-item>
              </el-col>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="路面材质" prop="theRoadSurfaceMaterial">
                  <el-input
                    v-model="data.theRoadSurfaceMaterial"
                    :disabled="readonly"
                    maxlength="200" />
                </el-form-item>
              </el-col>
          ...
          <el-tab-pane label="旅游厕所" v-if="id!=='new'">
            <reference-form :pdata="data"
                            refname="PublicTrails"
                            fieldname="touristToilets"
                            route-name="publicTrailTourismToilet"
          ...
          <el-tab-pane label="停车场" v-if="id!=='new'">
            <reference-form :pdata="data"
                            ...
                            route-name="publicTrailParkingLot"
...
<script>
  ...
  export default class PublicTrails extends Mixins(BaseForm) {
    @Prop({default: () => 'new'})
    id
