    ...
    <el-form label-width="100px"
      ...
      <el-tabs v-model="activeName">
        ...
        <el-tab-pane label="游客消费信息" name="consumptionMsgs" v-if="id!=='new'">
          <consumption-msgs
            :url="AllUrl.trivalEnterprise.enteringPolices+'/'+data.id"
...
<script>
  ...
  export default class EnteringPolice extends Mixins(BaseTable) {
    @Prop({ default: () => 'new' })
    id
    ...
    getUrl () {
      return this.AllUrl.trivalEnterprise.enteringPolices
    }
