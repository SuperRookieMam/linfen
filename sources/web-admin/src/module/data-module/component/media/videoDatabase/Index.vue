  ...
  <el-container>
    <el-main>
      ...
      <el-table-base
        ...
        <el-table-column label="视频规格" prop="videoSpecifications" />
        <el-table-column label="视频格式" prop="videoFormat" />
        <el-table-column label="文件大小" prop="theFileSize" />
        <el-table-column label="视频时长" prop="theVideoTime" />
        ...
        <el-table-column label="操作" :min-width="60">
          <template slot-scope="scope">
            <el-button type="text" size="mini" @click="edit(scope.row,'videoDatabase')">编辑</el-button>
...
<script>
  ...
  export default class Index extends Mixins(BaseTable) {
    ...
    getUrl () {
      return this.url ? this.url : this.AllUrl.trivalEnterprise.videos
    }
  }
</script>
