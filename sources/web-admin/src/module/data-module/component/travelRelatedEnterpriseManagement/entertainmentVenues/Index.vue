    ...
    <el-table-base
      ...
      <el-table-column label="操作" :min-width="60">
        <template slot-scope="scope">
          <el-button type="text" size="mini" @click="edit(scope.row,'entertainmentVenues')">编辑</el-button>
          <el-button type="text" size="mini" @click="delRow(scope.row,AllUrl.trivalEnterprise.entertainmentVenuess)">删除</el-button>
        </template>
      </el-table-column>
    </el-table-base>
  </div>
...
<script>
  ...
  export default class Index extends Mixins(BaseTable) {
    ...
    getUrl () {
      return this.url ? this.url : this.AllUrl.trivalEnterprise.entertainmentVenuess
    }
  }
</script>
