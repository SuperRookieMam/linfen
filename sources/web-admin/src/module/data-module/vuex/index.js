...
import ReferrenceModels from './ReferrenceModel'
...
export default {
  ...
  state: {},
  modules: {
    ReferrenceModel: ReferrenceModels,
    region: regions,
    ...
    touristAttractions: new BaseState({ url: `${CTX}/touristAttractions` }),
    ...
    shoppingPlace: new BaseState({ url: `${CTX}/shoppingPlaces` }),
    ...
    entertainmentVenues: new BaseState({ url: `${CTX}/entertainmentVenuess` })
  }
}
